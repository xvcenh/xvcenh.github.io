...
<div class="container">
  <div style="padding: 80px 0 var(--space-xl);">
    ...
    <div style="text-align: center; margin-bottom: var(--space-xl);">
      <h1 style="font-size: 2rem; margin-bottom: var(--space-md); color: var(--text-primary);">🔧 硬件问题</h1>
      <p style="font-size: 1.125rem; color: var(--text-secondary); max-width: 600px; margin: 0 auto; line-height: 1.7;">
        树莓派、传感器、电路设计、嵌入式系统等硬件相关问题与解决方案
      </p>
    </div>
    ...
    <div>
      ...
      <div class="empty-state">
        ...
        <h3 class="empty-title">暂无硬件问题记录</h3>
        <p class="empty-description">通过钉钉上传第一个硬件问题，开始积累硬件知识库</p>
